...
//   const { setTrack, tracksQueue, track } = useMusicPlayer(); // Access the queue and current track from context
...
//       // Play the audio automatically when it is ready
//       if (playing) {
...
//       }
//     } else {
//       console.error("Audio file URL is invalid or not provided.");
//     }
