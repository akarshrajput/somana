    ...
    <>
      <div className="px-4 mt-4">
        ...
        <div className="flex flex-col gap-6">
          <div className="grid text-stone-200 grid-cols-3 gap-2 gap-x-4 my-4">
            <BlogOfTheWeek />
          ...
          <div className="flex text-stone-200 flex-col gap-2">
            <TrendingBlogs />
          </div>
          <div className="grid text-stone-200 grid-cols-3 gap-2 gap-x-4 my-4">
            <div className="col-span-2">
          ...
          <div className="grid grid-cols-3 gap-2 text-stone-200 gap-x-4 my-4">
