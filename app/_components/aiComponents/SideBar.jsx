    ...
    <div className="p-4 font-medium w-full h-full">
      <div className="flex flex-col gap-2 h-full ">
        ...
        <div className="mt-auto grid grid-cols-2 gap-2 ">
          <LinkButton className="bg-red-600  hover:bg-red-600 text-stone-200  justify-center">
            Signup
          </LinkButton>
          <LinkButton className="bg-stone-200 text-stone-800  hover:bg-stone-300 justify-center">
            Login
          </LinkButton>
        </div>
      </div>
